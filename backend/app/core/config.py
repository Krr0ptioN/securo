...
class Settings(BaseSettings):
    ...
    supported_currencies: str = "USD,EUR,GBP,BRL,TRY,CAD,AUD,CHF,ARS,JPY,MXN,INR,SEK,DKK,NOK,PLN,CZK,HUF,RON,CRC,IDR,COP,CLP,DOP,RUB,GTQ,PHP,UAH,NZD,VND,SGD"  # comma-separated list
