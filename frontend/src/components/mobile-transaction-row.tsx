      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {tx.related_entity_type && (
            <span className="text-[9px] font-semibold uppercase tracking-wide text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-900 px-1 py-0.5 rounded-full" title={tx.related_entity_name ?? undefined}>
